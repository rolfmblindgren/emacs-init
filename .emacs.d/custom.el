...
(custom-set-variables
 ...
 '(TeX-engine 'xetex)
 '(TeX-tree-roots '("/usr/local/texlive/2023"))
 '(backup-directory-alist `(("." . "~/.emacs-backups")))
 '(connection-local-criteria-alist
   '(((:application tramp :machine "Rolfs-MBP.home")
      tramp-connection-local-darwin-ps-profile)
     ((:application tramp :protocol "kubernetes")
      tramp-kubernetes-connection-local-default-profile)
     ((:application tramp :machine "Rolfs-MBP")
      tramp-connection-local-darwin-ps-profile)
     ...
     ((:application tramp :machine "localhost")
      tramp-connection-local-darwin-ps-profile)
     ((:application tramp :machine "Rolfs-MacBook-Pro.local")
      tramp-connection-local-darwin-ps-profile)
     ((:application tramp)
 ...
 '(initial-frame-alist
   '((top . 1) (left . 1) (width . 80)
     `(height \, (/ (display-pixel-height) (line-pixel-height)))))
 '(ispell-dictionary "norsk")
 '(ispell-program-name "/opt/homebrew/bin/aspell")
 '(lua-default-application "/opt/homebrew/bin/lua")
